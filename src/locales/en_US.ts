...
const strings = {
  ...
  scan_evm_address_warning_title: 'EVM Address Detected',
  scan_evm_address_warning_body:
    'You scanned an Ethereum-style address (0x…). Confirm this is a Rootstock (RBTC) address before sending. Sending Bitcoin to the wrong EVM chain can permanently lose your funds.',
  scan_evm_address_warning_confirm: 'Yes, send to Rootstock',
