...
const strings = {
  ...
  arkade_exit_warning_collaborative:
    'While the Arkade operator (ASP) is online, Edge uses collaborative settle/offboard — faster and cheaper than a true force exit.',
  arkade_exit_warning_unilateral:
    'True unilateral exit (Unroll) works without the ASP but needs a challenge period, onchain fee UTXOs, and multi-step broadcasts. That path is not fully automated in Edge yet.',
  arkade_exit_warning_fees:
    'Network and operator fees apply. After exit, funds arrive onchain in the selected Bitcoin wallet.',
  arkade_exit_warning_destination:
    'Destination is a normal Bitcoin wallet (not Arkade). If you have none, Edge creates one when you open this screen.',
