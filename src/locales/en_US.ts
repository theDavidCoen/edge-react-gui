...
const strings = {
  ...
  fragment_transaction_list_tx_preconfirmed: 'Preconfirmed',
  fragment_transaction_list_tx_pending_boarding: 'Pending boarding',
  ...
  multisig_scene_title: 'Bitcoin Multisig',
  multisig_scene_body:
    'Choose how many cosigners and how many signatures are required. Invite other Edge users with their Nostr npub or NIP-05 address.',
  multisig_your_npub: 'Your Nostr npub',
  multisig_your_npub_body:
    'Share this with other Edge users so they can invite you as a cosigner. A Nostr identity is created automatically and stored in your Edge account.',
  multisig_cosigners_title: 'Number of cosigners',
  multisig_signatures_title: 'Signatures required',
  multisig_mode_npub: 'Invite Edge users (Nostr npub)',
  multisig_mode_xpub: 'Enter cosigner xpubs',
  multisig_cosigner_npub_s: 'Cosigner %s npub',
  multisig_cosigner_npub_or_nip05_s: 'Cosigner %s npub or NIP-05',
  multisig_cosigner_xpub_s: 'Cosigner %s xpub',
  multisig_create: 'Create Multisig Wallet',
  multisig_invite_cosigners: 'Invite cosigners',
  multisig_review_title: 'Confirm cosigners',
  multisig_review_body:
    'Each NIP-05 address is shown with the npub resolved from it.',
  multisig_edit_cosigners: 'Edit',
  multisig_duplicate_cosigner: 'Each cosigner must be unique',
  multisig_pending_title: 'Pending creation',
  multisig_pending_progress_s: '%1$s of %2$s cosigners confirmed',
  multisig_invite_title: 'Multisig wallet invite',
  multisig_invite_body_s:
    '%1$s invited you to a %2$s-of-%3$s Bitcoin multisig wallet. Slide to confirm and join this wallet.',
  multisig_invite_confirm: 'Join wallet',
  multisig_complete_toast: 'Multisig wallet is ready',
  multisig_invites_sent: 'Invites sent to cosigners',
  multisig_joined_waiting: 'You joined. Waiting for other cosigners.',
  multisig_invalid_npub: 'Enter a valid npub',
  multisig_invalid_npub_or_nip05: 'Enter a valid npub or NIP-05 address',
  multisig_nip05_not_found: 'Could not resolve that NIP-05 address',
  multisig_invalid_xpub: 'Enter a valid xpub, ypub, or zpub',
  multisig_need_all_fields: 'Fill in every cosigner field',
  multisig_invalid_cosigner_count: 'Cosigners must be between 2 and 15',
  multisig_invalid_signature_count:
    'Required signatures must be at least 1 and not more than the number of cosigners',
  multisig_banner_npub: 'Multisig npub',
  multisig_waiting_for_you: 'Waiting for you to join',
  multisig_waiting_cosigners: 'Waiting cosigners',
  multisig_cosigner_unknown: 'Unknown cosigner',
  multisig_cosigner_pending: 'Pending',
  multisig_cosigner_accepted: 'Accepted',
  multisig_invite_missing: 'This multisig invite is no longer available.',
  multisig_invite_retry: 'Check again',
  multisig_cosigner_you: 'You',
  multisig_reject_invite: 'Reject invite',
  multisig_reject_invite_body:
    'Reject this multisig wallet invite? You will not join this wallet. You can still receive invites for other multisig wallets later.',
  multisig_reject_invite_confirm: 'Reject',
  multisig_reject_invite_toast: 'Invite rejected',
  multisig_wallet_name: 'Wallet',
  multisig_threshold: 'Threshold',
  multisig_status: 'Status',
  multisig_status_complete: 'Ready',
  multisig_cosigner_status_s: 'Cosigner %s',
  multisig_invite_received_toast: 'Multisig invite received',
  multisig_notif_title: 'Multisig wallet invite',
  multisig_notif_body: 'Waiting for you to join a multisig wallet.',
  multisig_onchain_address: 'On-chain receive address (P2WSH)',
  multisig_receive_p2wsh_warning:
    'Send only to this P2WSH multisig address. Do not use the normal Bitcoin address for this wallet.',
  multisig_p2wsh_balance_label: 'Shared multisig balance',
  multisig_spend_banner_request:
    'This is a multisig wallet. Sliding to confirm sends a signature request to the other cosigners. The transaction is not broadcast until enough signatures are collected.',
  multisig_spend_banner_broadcast:
    'You are the final required cosigner. Sliding to confirm will broadcast the transaction to the Bitcoin network.',
  multisig_spend_banner_legacy:
    "These coins are on this account's personal Bitcoin address (received before shared P2WSH receive). Only this account can see and spend them. Sliding to confirm spends them normally. For true m-of-n spends, receive to the P2WSH address shown on Request.",
  multisig_spend_banner_loading:
    'Checking the shared multisig (P2WSH) balance…',
  multisig_spend_slider_request: 'Request cosignatures',
  multisig_spend_slider_broadcast: 'Broadcast transaction',
  multisig_spend_request_toast: 'Multisig send request received',
  multisig_spend_sent_toast: 'Cosignature request sent',
  multisig_spend_broadcast_toast: 'Multisig transaction broadcast',
  multisig_spend_rejected_toast: 'Multisig send rejected',
  multisig_spend_title: 'Multisig send request',
  multisig_spend_progress_s: '%1$s of %2$s signatures',
  multisig_spend_approve: 'Approve & sign',
  multisig_spend_reject: 'Reject',
  multisig_spend_reject_body:
    'Reject this multisig send request? Other cosigners will be notified.',
  multisig_spend_amount: 'Amount',
  multisig_spend_fee: 'Network fee',
  multisig_spend_destination: 'Destination',
  multisig_spend_status_signed: 'Signed',
  multisig_spend_status_pending: 'Awaiting signature',
  multisig_spend_status_rejected: 'Rejected',
  multisig_spend_missing: 'This send request is no longer available.',
  multisig_spend_single_sig_blocked:
    'No coins on the shared P2WSH multisig address yet. Fund this wallet from Request, then try again.',
  multisig_spend_p2wsh_balance_s: 'Shared multisig (P2WSH): %s',
  multisig_spend_notif_title: 'Multisig send request',
  multisig_spend_notif_body: 'A cosigner asked you to sign a Bitcoin send.',
  multisig_spend_pending_card: 'Pending multisig send',
  multisig_output_descriptor: 'Output descriptor',
  multisig_export_recovery: 'Export Multisig Recovery Info',
  multisig_export_recovery_title: 'Multisig Recovery Info',
  multisig_export_recovery_password_title: 'Multisig Recovery Info',
  multisig_export_recovery_password_message:
    'This export is a BIP-380 output descriptor. It does not include private keys. To sign spends outside Edge you still need your cosigner private key.',
  multisig_export_recovery_body:
    'Copy this information to restore or watch this multisig wallet outside Edge. It includes the output descriptor, cosigner xpubs, and P2WSH address.',
  multisig_export_unavailable: 'Multisig recovery info is not available yet.',
  multisig_cannot_mix_assets:
    'Bitcoin Multisig cannot be created or imported with other assets. Select it by itself.',
  multisig_import_descriptor: 'Output descriptor or BSMS',
  multisig_import_descriptor_placeholder: 'Paste wsh(sortedmulti…) or BSMS 1.0',
  multisig_import_invalid_descriptor:
    'Could not parse the output descriptor or BSMS text',
  multisig_import_signer_only:
    'This looks like a single-keystore BSMS file. Paste the wallet output descriptor or the wallet BSMS export instead.',
  multisig_import_seed_mismatch:
    'This seed does not match any cosigner in the descriptor',
  multisig_import_address_mismatch:
    'The BSMS first address does not match this descriptor',
  ...
  nostr_account_import_body:
    'Already use Nostr? Paste your nsec to replace the Edge-generated key for multisig invites and display name.',
  nostr_account_import_warning:
    'Importing replaces your current Nostr account in Edge. Multisig messaging will use the imported private key.',
  ...
  nostr_account_private_key_warning:
    'Do not share your Nostr private key. Anyone with this key can impersonate you on Nostr and read your encrypted multisig messages.',
  ...
  request_qr_your_arkade_address: 'Your Arkade Address',
  request_qr_your_boarding_address: 'Your Bitcoin Address (boarding)',
  request_qr_your_lnurl_address: 'Your LNURL',
  ...
  settings_arkade_operator_title: 'Custom Arkade Operator',
  settings_arkade_operator_info:
    'Edge connects to the Arkade Operator (ASP) for offchain Bitcoin. Leave custom off to use the default Arkade Operator.',
  settings_arkade_enable_custom_operator: 'Enable Custom Operator',
  settings_arkade_operator_url: 'Operator URL',
  settings_arkade_default_operator: 'Default Operator',
  settings_arkade_edit_operator: 'Edit Arkade Operator',
  settings_arkade_delegate_title: 'Delegate',
  settings_arkade_delegate_info:
    'Auto-delegate renews expiring VTXOs via the Arkade delegate (default: https://delegate.arkade.money). Turn on Custom Delegate only to use your own URL.',
  settings_arkade_enable_delegate: 'Enable Delegate',
  settings_arkade_enable_custom_delegate: 'Custom Delegate',
  settings_arkade_delegate_url: 'Delegate URL',
  settings_arkade_default_delegate: 'Default Delegate',
  settings_arkade_edit_delegate: 'Edit Custom Delegate',
  ...
  // #region Countdown Duration
  // Used for countdown timers (e.g., quote expiration)
  countdown_hours: '>%sh',
  ...
  spend_crypto_gift_cards_footer:
    'Buy gift cards privately with no KYC from thousands of merchants!',
